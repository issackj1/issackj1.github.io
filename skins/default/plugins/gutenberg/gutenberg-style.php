...
if ( ! function_exists( 'urbanism_gutenberg_get_css' ) ) {
	add_filter( 'urbanism_filter_get_css', 'urbanism_gutenberg_get_css', 10, 2 );
	function urbanism_gutenberg_get_css( $css, $args ) {
