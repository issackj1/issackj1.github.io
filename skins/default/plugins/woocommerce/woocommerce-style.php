...
if ( ! function_exists( 'urbanism_woocommerce_get_css' ) ) {
	add_filter( 'urbanism_filter_get_css', 'urbanism_woocommerce_get_css', 10, 2 );
	function urbanism_woocommerce_get_css( $css, $args ) {
...
$fdir = urbanism_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
