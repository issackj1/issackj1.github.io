...
if ( ! function_exists( 'urbanism_trx_addons_get_css' ) ) {
	add_filter( 'urbanism_filter_get_css', 'urbanism_trx_addons_get_css', 10, 2 );
	function urbanism_trx_addons_get_css( $css, $args ) {
