...
Please install and activate it before starting to use the theme Urbanism.
...
Theme documentation is available on https://urbanism.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Urbanism is Fontello.
